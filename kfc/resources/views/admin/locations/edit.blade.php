        ...
        <div class="col-md-8">
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">Update {{ $location['store_name'] ?? 'location' }} details</p>
                </div>
            </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('admin.locations.update', $location['location_id'] ?? 0) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           id="store_name" 
                                           name="store_name" 
                                           value="{{ old('store_name', $location['store_name'] ?? '') }}" 
                                           required
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="time" 
                                           ...
                                           id="opening_time" 
                                           name="opening_time" 
                                           value="{{ old('opening_time', $location['opening_time'] ?? '06:00') }}">
                                    @error('opening_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="time" 
                                           ...
                                           id="closing_time" 
                                           name="closing_time" 
                                           value="{{ old('closing_time', $location['closing_time'] ?? '23:00') }}">
                                    @error('closing_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
