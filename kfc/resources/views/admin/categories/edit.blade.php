        ...
        <div class="col-md-8">
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0">Update {{ $category['category_name'] ?? 'category' }} details</p>
                </div>
            </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('admin.categories.update', $category['category_id'] ?? 0) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
